...
const aValue = (completions, attempts) => {
  ...
  const cValue = (touchdowns, attempts) => {
    ...
    const dValue = (interceptions, attempts) => {
      ...
      const eValue = (completions, attempts, yards, touchdowns, interceptions) => {
